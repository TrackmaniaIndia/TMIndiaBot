...
from util.trackmania.tm2020.leaderboards.campaign import _get_all_fall_campaign_ids, update_leaderboards_campaign
...
class Trackmania(commands.Cog):
    ...
    async def _update_campaign_leaderboards(self, ctx: commands.Context):
        ...
        message = await ctx.respond(embed=ezembed.create_embed(title='Are you sure you want to continue?', description='This can take over 10minutes, the bot will be unusable in this period', color=discord.Colour.red()),view=confirm_continue)
